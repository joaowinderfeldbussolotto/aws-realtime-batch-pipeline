...
PRECIPITATION_PROBABILITY_THRESHOLD = int(os.getenv('PRECIPITATION_PROBABILITY'))
WIND_SPEED_THRESHOLD = int(os.getenv('WIND_SPEED'))
WIND_GUST_THRESHOLD = int(os.getenv('WIND_GUST'))
RAIN_INTENSITY_THRESHOLD = int(os.getenv('RAIN_INTENSITY'))
